...
class PrestaShopWebservice
{
	...
	$request_type = 'PUT';
        ...
        //$request = $this->executeRequest($url, array(CURLOPT_CUSTOMRCURLOPT_CUSTOMREQUEST => $request_type, CURLOPT_POSTFIELDS => $xml));
        $request = $this->executeRequest($url, array(CURLOPT_CUSTOMREQUEST => $request_type, CURLOPT_POSTFIELDS => $xml));
        $this->checkStatusCode($request);// check the response validity
        return $this->parseXML($request['response']);
    }
